...
public class MenuPanel extends JPanel {
    ...
    // הבנאי של פאנל התפריט; בונה את אלמנטים הגרפיים, טוען את תמונת הרקע ומגדיר אירועים לשינוי שפה ולכפתור בחירת מצב.
    ...
    // מציירת את הרכיב; מותחת את תמונת רקע החלל על כל שטח הפאנל או ממלאת אותו בצבע גיבוי כהה.
    @Override
    ...
    // מציגה דיאלוג בחירה קופץ (JOptionPane) לבחירת סוג המשימה הרצויה ומעבירה את הבחירה לאובייקט המשחק.
    ...
    // מעדכנת את כל מחרוזות הטקסט וכיווני היישור של הפאנל (מימין לשמאל או משמאל לימין) בהתאם לשפה הפעילה.
